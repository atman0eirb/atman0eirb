 ...
 * http://jquery.org/license
 *
 */if(!e.expr.pseudos){e.expr.pseudos=e.expr[":"]}if(!e.uniqueSort){e.uniqueSort=e.unique}if(!e.escapeSelector){var a=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g;var l=function(e,t){if(t){if(e==="\0"){return"ï¿½"}return e.slice(0,-1)+"\\"+e.charCodeAt(e.length-1).toString(16)+" "}return"\\"+e};e.escapeSelector=function(e){return(e+"").replace(a,l)}}if(!e.fn.even||!e.fn.odd){e.fn.extend({even:function(){return this.filter((function(e){return e%2===0}))},odd:function(){return this.filter((function(e){return e%2===1}))}})}
/*!
